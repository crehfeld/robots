 ...
 */
public class ImageMapAnalyzer implements MapFeatures {
     ...
     */
    public ImageMapAnalyzer(File mapFile) throws IOException {
     ...
     * house features
     */
    public ImageMapAnalyzer(BufferedImage img) {
        this.img = img;
        analyzeImage();
    }
    ...
    public boolean[][] getFreeSpaceMatrix() {
        boolean[][] copy = new boolean[freeSpaces.length][];
        for (int i = 0; i < freeSpaces.length; i++) {
            copy[i] = freeSpaces[i].clone();
        }
        return copy;
    }
